...
class uuid_registry
{
 public:
    ...
    void
    add(std::string const& uuid, std::type_index key);
 ...
 private:
    ...
    std::unordered_map<std::type_index, std::string> map_;
    std::unordered_map<std::string, std::type_index> inverse_map_;

    void
    add_to_map(std::string const& uuid, std::type_index key);
    void
    add_to_inverse_map(std::string const& uuid, std::type_index key);
};
...
void
register_polymorphic_type(std::string const& uuid)
{
