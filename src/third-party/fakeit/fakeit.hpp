...
class is_ostreamable
{
    ...
    static decltype(operator<<(
        std::declval<std::ostream&>(), std::declval<const Type1>()))
    test(std::ostream& s, const Type1& t);
#else
    template<typename Type1>
    static auto
    test(std::ostream& s, const Type1& t) -> decltype(s << t);
#endif
    static no
    test(...);
 ...
 public:
    static const bool value
        = std::is_arithmetic<T>::value || std::is_pointer<T>::value
          || std::is_same<
              decltype(test(*(std::ostream*) nullptr, std::declval<T>())),
              std::ostream&>::value;
};
...
{
    static void
    print(std::ostream& strm, const Tuple& t)
    {
...
struct ActualInvocation : public Invocation
{
    ...
    {
        virtual bool
        matches(ActualInvocation<arglist...>& actualInvocation)
            = 0;
    ...
    void
    setActualMatcher(Matcher* matcher)
    {
...
{
    virtual void
    getActualInvocations(std::unordered_set<fakeit::Invocation*>& into) const
        = 0;
...
struct AggregateInvocationsSource : public ActualInvocationsSource
{
 ...
 protected:
    bool
    shouldInclude(fakeit::Invocation*) const
    {
        return true;
    }
 ...
 private:
    ...
    void
    filter(
        std::unordered_set<Invocation*>& source,
...
class Sequence
{
 ...
 public:
    virtual void
    getExpectedSequence(std::vector<Invocation::Matcher*>& into) const
        = 0;
...
class ConcatenatedSequence : public virtual Sequence
{
 ...
 public:
    ...
    friend inline ConcatenatedSequence
...
class RepeatedSequence : public virtual Sequence
{
 ...
 public:
    ...
    friend inline RepeatedSequence
...
struct VerificationEvent
{
    ...
    VerificationType
    verificationType() const
    {
        return _verificationType;
    }

    void
    setFileInfo(const char* aFile, int aLine, const char* aCallingMethod)
    {
        _file = aFile;
...
struct SequenceVerificationEvent : public VerificationEvent
{
    ...
    expectedPattern() const
    {
        return _expectedPattern;
    }

    const std::vector<Invocation*>&
    actualSequence() const
    {
...
struct UnexpectedMethodCallEvent
{
    UnexpectedMethodCallEvent(
        UnexpectedType unexpectedType, const Invocation& invocation)
...
{
    virtual void
    handle(const SequenceVerificationEvent& e)
        = 0;

    virtual void
    handle(const NoMoreInvocationsVerificationEvent& e)
        = 0;
};
...
struct EventHandler : public VerificationEventHandler
{
    ...
    virtual void
    handle(const UnexpectedMethodCallEvent& e)
        = 0;
};
...
struct EventFormatter
{
    ...
    virtual std::string
    format(const fakeit::UnexpectedMethodCallEvent& e)
        = 0;

    virtual std::string
    format(const fakeit::SequenceVerificationEvent& e)
        = 0;

    virtual std::string
    format(const fakeit::NoMoreInvocationsVerificationEvent& e)
        = 0;
};
...
struct FakeitContext : public EventHandler, protected EventFormatter
{
    ...
    void
    handle(const UnexpectedMethodCallEvent& e) override
    {
        fireEvent(e);
    ...
    void
    handle(const SequenceVerificationEvent& e) override
    {
        fireEvent(e);
        auto& eh = getTestingFrameworkAdapter();
        return eh.handle(e);
    ...
    void
    handle(const NoMoreInvocationsVerificationEvent& e) override
    {
        fireEvent(e);
        auto& eh = getTestingFrameworkAdapter();
        return eh.handle(e);
    ...
    std::string
    format(const UnexpectedMethodCallEvent& e) override
    {
    ...
    std::string
    format(const SequenceVerificationEvent& e) override
    {
        auto& eventFormatter = getEventFormatter();
        return eventFormatter.format(e);
    }
    ...
    void
    addEventHandler(EventHandler& eventListener)
    {
 ...
 private:
    ...
    void
    fireEvent(const NoMoreInvocationsVerificationEvent& evt)
    {
    ...
    void
    fireEvent(const UnexpectedMethodCallEvent& evt)
    {
        for (auto listener : _eventListeners)
            listener->handle(evt);
    }
    ...
    void
    fireEvent(const SequenceVerificationEvent& evt)
    {
        for (auto listener : _eventListeners)
            listener->handle(evt);
    }
...
struct DefaultEventFormatter : public EventFormatter
{
    ...
    format(const UnexpectedMethodCallEvent& e) override
    {
        ...
        {
            out << "  An unmocked method was invoked. All used virtual "
                   "methods must be stubbed!";
        }
        return out.str();
    }
 ...
 private:
    static std::string
    formatSequence(const Sequence& val)
    {
    ...
    static std::string
    format(const ConcatenatedSequence& val)
    {
        std::ostringstream out;
    ...
    static std::string
    format(const RepeatedSequence& val)
    {
        std::ostringstream out;
        const ConcatenatedSequence* cs
...
struct FakeitException
{
    ...
    friend std::ostream&
    operator<<(std::ostream& os, const FakeitException& val)
    {
        os << val.what();
        return os;
    }
...
class DefaultFakeit : public AbstractFakeit
{
 ...
 public:
    ...
    void
    setCustomEventFormatter(fakeit::EventFormatter& customEventFormatter)
    {
        _customFormatter = &customEventFormatter;
    }

    void
    resetCustomEventFormatter()
    {
        _customFormatter = nullptr;
    }
 ...
 protected:
    fakeit::EventHandler&
    getTestingFrameworkAdapter() override
    {
...
class CatchAdapter : public EventHandler
{
    ...
    std::string
    formatLineNumber(std::string file, int num)
    {
#ifndef __GNUG__
 ...
 public:
    ...
    virtual void
    handle(const UnexpectedMethodCallEvent& evt) override
    {
    ...
    virtual void
    handle(const SequenceVerificationEvent& evt) override
    {
        std::string format(
            formatLineNumber(evt.file(), evt.line()) + ": "
            + _formatter.format(evt));
        std::string expectedPattern{
            DefaultEventFormatter::formatExpectedPattern(
                evt.expectedPattern())};
        fail(
            "Verify",
...
class CatchFakeit : public DefaultFakeit
{
 ...
 protected:
    fakeit::EventHandler&
    accessTestingFrameworkAdapter() override
    {
...
#pragma GCC diagnostic pop
    ...
    template<typename C>
    FAKEIT_DISARM_UBSAN static typename std::
        enable_if<std::has_virtual_destructor<C>::value, unsigned int>::type
        getDestructorOffset()
    {
        VirtualOffsetSelector offsetSelctor;
    ...
    template<typename C>
    static typename std::
        enable_if<std::has_virtual_destructor<C>::value, bool>::type
...
struct RTTIClassHierarchyDescriptor
{
    ...
    {
        static_assert(
            std::is_base_of<BaseType, C>::value,
    ...
    {
        static_assert(
            std::is_base_of<Base1, head>::value, "invalid inheritance list");
        addBaseClass<head>();
...
struct VirtualTableBase
{
    ...
    static VirtualTableBase&
    getVTable(void* instance)
    {
    ...
    void
    setCookie(int index, void* value)
    {
    ...
    void
    setMethod(unsigned int index, void* method)
    {
...
struct VirtualTable : public VirtualTableBase
{
    ...
    static VirtualTable<C, baseclasses...>&
    getVTable(C& instance)
    {
    ...
    void
    copyFrom(VirtualTable<C, baseclasses...>& from)
    {
 ...
 private:
    ...
    static_assert(
        sizeof(unsigned int (SimpleType::*)())
            == sizeof(unsigned int (C::*)()),
        "Can't mock a type with multiple inheritance or with non-polymorphic "
        "base class");
...
#ifndef __clang__
    static_assert(
        is_simple_inheritance_layout<C>::value,
                       ...
                       BaseClasses...>
{
 ...
 public:
    ...
    void
    setVirtualTable(VirtualTable<C, BaseClasses...>& t)
    {
        this->vtable = t;
    }
...
struct InvocationHandlerCollection
{
    ...
    virtual Destructible*
    getInvocatoinHandlerPtrById(unsigned int index)
        = 0;
...
class MethodProxyCreator
{
 ...
 public:
    ...
    MethodProxy
    createMethodProxy(unsigned int offset)
    {
        return MethodProxy(
            id,
            offset,
    ...
    template<unsigned int id>
    MethodProxy
    createMethodProxyStatic(unsigned int offset)
    {
        return MethodProxy(
            id,
            offset,
 ...
 protected:
    ...
    template<int id>
    static R
    methodProxyXStatic(void* instance, arglist... args)
    {
...
class InvocationHandlers : public InvocationHandlerCollection
{
    ...
    unsigned int
    getOffset(unsigned int id) const
    {
 ...
 public:
    ...
    Destructible*
    getInvocatoinHandlerPtrById(unsigned int id) override
    {
...
struct DynamicProxy
{
          ...
          _invocationHandlers(_methodMocks, _offsets)
    {
        ...
        _cloneVt.setCookie(
            InvocationHandlerCollection::VtCookieIndex, &_invocationHandlers);
        ...
        MethodInvocationHandler<R, arglist...>* methodInvocationHandler)
    {
        ...
        bind(
            creator.template createMethodProxy<id + 1>(offset),
            methodInvocationHandler);
    }

    void
    stubDtor(MethodInvocationHandler<void>* methodInvocationHandler)
    {
...
#ifdef _MSC_VER
        bindDtor(
            creator.createMethodProxyStatic<0>(offset),
            methodInvocationHandler);
#else
        bindDtor(
            creator.createMethodProxy<0>(offset), methodInvocationHandler);
#endif
    }

    template<typename R, typename... arglist>
    bool
    isMethodStubbed(R (C::*vMethod)(arglist...))
    {
    ...
    template<typename R, typename... arglist>
    Destructible*
    getMethodMock(R (C::*vMethod)(arglist...))
    {
        auto offset = VTUtils::getOffset(vMethod);
        std::shared_ptr<Destructible> ptr = _methodMocks[offset];
        return ptr.get();
    ...
    void
    stubDataMember(DataType C::*member, const arglist&... initargs)
    {
        ...
        _members.push_back(
            std::shared_ptr<DataMemeberWrapper<DataType, arglist...>>{
                new DataMemeberWrapper<DataType, arglist...>(
                    memberPtr, initargs...)});
    }

    template<typename DataType>
    void
    getMethodMocks(std::vector<DataType>& into) const
    {
    ...
    template<typename R, typename... arglist>
    Finally
    createRaiiMethodSwapper(R (C::*vMethod)(arglist...))
    {
        auto offset = VTUtils::getOffset(vMethod);
 ...
 private:
    ...
    static_assert(
        sizeof(C) == sizeof(FakeObject<C, baseclasses...>),
        "This is a problem");
    ...
    void
    bind(const MethodProxy& methodProxy, Destructible* invocationHandler)
    {
    ...
    void
    bindDtor(const MethodProxy& methodProxy, Destructible* invocationHandler)
    {
    ...
    template<typename DataType>
    DataType
    getMethodMock(unsigned int offset)
    {
        std::shared_ptr<Destructible> ptr = _methodMocks[offset];
...
struct apply_func
{
    ...
    static R
    applyTuple(FunctionType&& f, std::tuple<ArgsT...>& t, Args&... args)
    {
...
struct apply_func<0>
{
    template<
        ...
        typename FunctionType>
    static R
    applyTuple(FunctionType&& f, std::tuple<ArgsT...>&, Args&... args)
    {
...
struct TupleDispatcher
{
    ...
    template<
        ...
        typename FunctionType>
    static R
    applyTuple(FunctionType&& f, std::tuple<ArgsT...>& t)
    {
    ...
    static R
    invoke(FunctionType&& func, const std::tuple<arglist...>& arguments)
    {
    ...
    static void
    for_each(TupleType&& t, FunctionType& f, std::integral_constant<size_t, I>)
    {
        f(I, std::get<I>(t));
        for_each(
    ...
    template<typename TupleType, typename FunctionType>
    static void
    for_each(TupleType&& t, FunctionType& f)
    {
        for_each(
            std::forward<TupleType>(t),
            f,
    ...
    template<typename TupleType1, typename TupleType2, typename FunctionType>
    static void
    for_each(TupleType1&& t, TupleType2&& t2, FunctionType& f)
    {
        for_each(
            std::forward<TupleType1>(t),
            std::forward<TupleType2>(t2),
...
{
    virtual R
    handleMethodInvocation(ArgumentsTuple<arglist...>& args)
        = 0;
};
        ...
        class Exception : public DefaultValueInstatiationException
        {
                ...
                override
            {
                return (std::string("Type ") + std::string(typeid(C).name())
                        + std::string(
                            " is not default constructible. Could not "
...
{
    virtual bool
    matches(const ActualT& actual) const
        = 0;
};
...
struct ComparisonMatcherCreatorBase
{
    ...
    struct MatcherBase<
        ...
        typename std::enable_if<
            std::is_same<U, ExpectedT>::value
            && std::is_array<U>::value>::type> : public TypedMatcher<ActualT>
    {
        ExpectedT _expected;
...
struct AnyMatcherCreator
{
    ...
    template<typename ActualT>
    TypedMatcher<ActualT>*
    createMatcher() const
    {
        struct Matcher : public TypedMatcher<ActualT>
        {
            bool
            matches(const ActualT&) const override
            {
                return true;
            }
...
struct EqMatcherCreator : public ComparisonMatcherCreatorBase<ExpectedTRef>
{
    ...
    struct IsTypeCompatible<
        ActualT,
        fk_void_t<
            decltype(std::declval<ActualT>() == std::declval<ExpectedT>())>>
        : std::true_type
    {
    };
    ...
    createMatcher() const
    {
                             ...
                             ExpectedTRef>::template MatcherBase<ActualT>
        {
            ...
            virtual bool
            matches(const ActualT& actual) const override
            {
...
struct StrEqMatcherCreator : public ComparisonMatcherCreatorBase<ExpectedTRef>
{
    ...
    struct IsTypeCompatible<
        ActualT,
        fk_void_t<decltype(strcmp(
            std::declval<ActualT>(), std::declval<const char*>()))>>
        : std::true_type
    {
    };
...
struct ApproxEqCreator
{
    ...
    struct IsTypeCompatible<
        ActualT,
        fk_void_t<
            decltype(std::abs(std::declval<ActualT>() - std::declval<ExpectedT>()) <= std::declval<ExpectedMarginT>())>>
        : std::true_type
    {
    };
...
Any()
{
    static_assert(
        sizeof(T) >= 0,
        "To maintain backward compatibility, this function takes an useless "
        "template argument.");
...
{
    internal::ApproxEqCreator<T&&, U&&> mc(
        std::forward<T>(expected), std::forward<U>(margin));
    return mc;
}
    ...
    : public ActualInvocation<arglist...>::Matcher
{
    ...
    virtual bool
    matches(ActualInvocation<arglist...>& invocation) override
    {
 ...
 private:
    struct MatchingLambda
    {
        ...
        template<typename A>
        void
        operator()(int index, A& actualArg)
        {
    ...
    virtual bool
    matches(ArgumentsTuple<arglist...>& actualArguments)
    {
...
struct UserDefinedInvocationMatcher : ActualInvocation<arglist...>::Matcher
{
 ...
 private:
    ...
    matches(ArgumentsTuple<arglist...>& actualArguments)
    {
        return TupleDispatcher::
            invoke<bool, typename tuple_arg<arglist>::type...>(
...
struct DefaultInvocationMatcher : public ActualInvocation<arglist...>::Matcher
{
 ...
 private:
    virtual bool
    matches(const ArgumentsTuple<arglist...>&)
    {
        return true;
    }
};
                           ...
                           public ActualInvocationsContainer
{
    ...
    struct MatchedInvocationHandler : ActualInvocationHandler<R, arglist...>
    {
        ...
        typename ActualInvocation<arglist...>::Matcher&
        getMatcher() const
        {
    ...
    MatchedInvocationHandler*
    buildMatchedInvocationHandler(
        typename ActualInvocation<arglist...>::Matcher* invocationMatcher,
        ActualInvocationHandler<R, arglist...>* invocationHandler)
    {
        return new MatchedInvocationHandler(
            invocationMatcher, invocationHandler);
    }
 ...
 public:
        ...
        const typename fakeit::production_arg<arglist>::type... args) override
    {
        ...
        UnexpectedMethodCallEvent event(
            UnexpectedType::Unmatched, *actualInvocation);
    ...
    void
    setMethodDetails(
        const std::string& mockName, const std::string& methodName)
    {
    ...
    _Time(unsigned long long n)
{
    if (n != 1)
        throw std::invalid_argument(
            "Only 1_Time is supported. Use X_Times (with s) if X is bigger "
            "than 1");
    return QuantifierFunctor((int) n);
}
...
{
    virtual R
    invoke(const ArgumentsTuple<arglist...>&)
        = 0;
...
struct Repeat : Action<R, arglist...>
{
    ...
    virtual R
    invoke(const ArgumentsTuple<arglist...>& args) override
    {
        times--;
...
struct ReturnDefaultValue : public Action<R, arglist...>
{
    ...
    virtual R
    invoke(const ArgumentsTuple<arglist...>&) override
    {
...
struct MethodStubbingProgress
{
    ...
    {
        return Do(GetAssigner(
            std::forward<R>(r), std::forward<valuelist>(arg_vals)...));
    }

    template<typename... valuelist>
    void
    AlwaysReturnAndSet(R&& r, valuelist&&... arg_vals)
    {
        AlwaysDo(GetAssigner(
            std::forward<R>(r), std::forward<valuelist>(arg_vals)...));
    }
 ...
 protected:
    virtual MethodStubbingProgress<R, arglist...>&
    DoImpl(Action<R, arglist...>* action)
        = 0;

 private:
    MethodStubbingProgress&
    operator=(const MethodStubbingProgress& other)
        = delete;
    ...
    GetAssigner(R&& r, valuelist&&... arg_vals)
    {
        class Lambda
        {
         public:
            ...
            R
            operator()(typename fakeit::test_arg<arglist>::type... args)
            {
...
struct MethodStubbingProgress<void, arglist...>
{
    ...
    template<typename... valuelist>
    void
    AlwaysReturnAndSet(valuelist&&... arg_vals)
    {
 ...
 protected:
    virtual MethodStubbingProgress<void, arglist...>&
    DoImpl(Action<void, arglist...>* action)
        = 0;
...
struct ArgValidator
{
    template<typename... T, int... N>
    static void
    CheckPositions(const std::tuple<ArgValue<T, N>...> arg_vals)
    {
#if FAKEIT_CPLUSPLUS >= 201402L && !defined(_WIN32)
        static_assert(
            std::get<tuple_index>(arg_vals).pos <= max_index,
...
typename std::enable_if<
    std::is_pointer<current_arg>::value,
...
template<typename current_arg>
typename std::enable_if<!std::is_pointer<current_arg>::value, current_arg>::
    type
    GetArg(current_arg&& t)
{
...
struct ParamWalker
{
    ...
    static void
    Assign(
        ArgumentsTuple<valuelist...> arg_vals,
        current_arg&& p,
        arglist&&... args)
    {
        ParamWalker<N - 1>::template Assign(
            arg_vals, std::forward<arglist>(args)...);
...
struct ParamWalker<0>
{
    ...
    static void
    Assign(ArgumentsTuple<valuelist...>, arglist...)
    {
    }
};
...
struct ArgLocator
{
    ...
    static void
    AssignArg(current_arg&& p, std::tuple<ArgValue<T, N>...> arg_vals)
    {
...
static void
Assign(
    std::tuple<ArgValue<T, N>...> arg_vals, current_arg&& p, arglist&&... args)
{
...
struct ActionSequence : ActualInvocationHandler<R, arglist...>
{
    ...
    void
    AppendDo(Action<R, arglist...>* action)
    {
        append(action);
    }
 ...
 private:
    ...
    void
    append(Action<R, arglist...>* action)
    {
...
{
    virtual void
    appendAction(Action<R, arglist...>* action)
        = 0;

    virtual std::function<R(arglist&...)>
...
class MatchersCollector
{
 ...
 public:
    ...
    struct IsMatcherCreatorTypeCompatible<
        MatcherCreatorT,
        typename std::enable_if<
            MatcherCreatorT::template IsTypeCompatible<
    ...
    void
    CollectMatchers(Head&& head, Tail&&... tail)
    {
                             ...
                             private Invocation::Matcher
{
 public:
    struct Context : Destructible
    {
        ...
        virtual void
        setMethodDetails(std::string mockName, std::string methodName)
            = 0;
        ...
        virtual ActualInvocationsSource&
        getInvolvedMock()
            = 0;
    };
 ...
 private:
    class Implementation
    {
     ...
     public:
        ...
        ActionSequence<R, arglist...>&
        getRecordedActionSequence()
        {
        ...
        void
        getActualInvocations(std::unordered_set<Invocation*>& into) const
        {
        ...
        getOriginalMethodCopyArgs()
        {
            return getStubbingContext().getOriginalMethodCopyArgs();
        }

        typename std::function<R(arglist&...)>
        getOriginalMethodForwardArgs()
        {
 ...
 protected:
    ...
    bool
    matches(Invocation& invocation) override
    {
    ...
    void
    setMatchingCriteria(std::vector<Destructible*>& matchers)
    {
        typename ActualInvocation<arglist...>::Matcher* matcher{
    ...
    void
    appendAction(Action<R, arglist...>* action) override
    {
    ...
    typename std::
        enable_if<sizeof...(matcherCreators) == sizeof...(arglist), void>::type
...
class MockingContext : public MethodMockingContext<R, arglist...>
{
 ...
 public:
    ...
    setMethodDetails(std::string mockName, std::string methodName)
    {
        MethodMockingContext<R, arglist...>::setMethodDetails(
            mockName, methodName);
        return *this;
    }
    ...
    MockingContext<R, arglist...>&
    Using(arg_matcher&&... arg_matchers)
    {
    ...
    : public MethodMockingContext<void, arglist...>
{
 ...
 public:
    ...
    setMethodDetails(std::string mockName, std::string methodName)
    {
        MethodMockingContext<void, arglist...>::setMethodDetails(
            mockName, methodName);
        return *this;
    }
    ...
    void
    operator=(std::function<void(arglist&...)> method)
    {
...
class DtorMockingContext : public MethodMockingContext<void>
{
 public:
    ...
    void
    operator=(std::function<void()> method)
    {
...
class MockImpl : private MockObject<C>, public virtual ActualInvocationsSource
{
 public:
    ...
    template<
        ...
        class = typename std::enable_if<std::is_base_of<T, C>::value>::type>
    MockingContext<R, arglist...>
    stubMethod(R (T::*vMethod)(arglist...))
    {
        return MockingContext<R, arglist...>(
            new UniqueMethodMockingContextImpl<id, R, arglist...>(
                *this, vMethod));
    }
 ...
 private:
    ...
    static FakeObject<C, baseclasses...>*
    asFakeObject(void* instance)
    {
        return reinterpret_cast<FakeObject<C, baseclasses...>*>(instance);
    }
        ...
        : public MethodMockingContextBase<R, arglist...>
    {
     ...
     public:
        ...
        MethodMockingContextImpl(
            MockImpl<C, baseclasses...>& mock, R (C::*vMethod)(arglist...))
        ...
        getOriginalMethodCopyArgsInternal(int)
        {
            auto mPtr = _vMethod;
        ...
        : public MethodMockingContextImpl<R, arglist...>
    {
     ...
     public:
        UniqueMethodMockingContextImpl(
            MockImpl<C, baseclasses...>& mock, R (C::*vMethod)(arglist...))
    ...
    class DtorMockingContextImpl : public MethodMockingContextBase<void>
    {
     ...
     protected:
        virtual RecordedMethodBody<void>&
        getRecordedMethodBody() override
        {
    ...
    static MockImpl<C, baseclasses...>*
    getMockImpl(void* instance)
    {
    ...
    unmocked()
    {
        ActualInvocation<> invocation(
            Invocation::nextInvocationOrdinal(), UnknownMethod::instance());
    ...
    template<typename R, typename... arglist>
    void*
    getOriginalMethod(R (C::*vMethod)(arglist...))
    {
    ...
    {
        return new RecordedMethodBody<R, arglist...>(
            mock.getFakeIt(), typeid(vMethod).name());
    }
...
struct Prototype<R(Args...)>
{
    ...
    struct MemberType
    {
        ...
        static ConstRefType
        getConstRef(ConstRefType t)
        {
            return t;
        }

        static RValRefType
        getRValRef(RValRefType t)
        {
            return t;
        }

        static ConstRValRefType
        getConstRValRef(ConstRValRefType t)
        {
            return t;
        }
    };
...
class Mock : public ActualInvocationsSource
{
 ...
 public:
    ...
    static_assert(
        std::is_polymorphic<C>::value, "Can only mock a polymorphic type");
    ...
    DataMemberStubbingRoot<C, DataType>
    Stub(DataType C::*member, const arglist&... ctorargs)
    {
    ...
    stub(R (T::*vMethod)(arglist...) const)
    {
        auto methodWithoutConstVolatile
            = reinterpret_cast<internal::WithCommonVoid_t<R> (T::*)(
                arglist...)>(vMethod);
...
class FakeFunctor
{
 private:
    template<typename R, typename... arglist>
    void
    fake(const StubbingContext<R, arglist...>& root)
    {
        StubbingContext<R, arglist...>& rootWithoutConst
 ...
 public:
    ...
    void
    operator()(const H& head, const M&... tail)
    {
        fake(head);
        this->operator()(tail...);
    }
...
struct InvocationUtils
{
    ...
    static void
    collectSequences(std::vector<Sequence*>&)
    {
    }
...
struct MatchAnalysis
{
    ...
    void
    run(InvocationsSourceProxy& involvedInvocationSources,
        std::vector<Sequence*>& expectedPattern)
    {
        getActualInvocationSequence(involvedInvocationSources, actualSequence);
        count = countMatches(
            expectedPattern, actualSequence, matchedInvocations);
    }

 private:
    static void
    getActualInvocationSequence(
        ...
        std::vector<Invocation*>& actualSequence)
    {
        ...
        InvocationUtils::sortByInvocationOrder(
            actualInvocations, actualSequence);
    }
...
struct SequenceVerificationExpectation
{
    ...
    void
    setExpectedPattern(std::vector<Sequence*> expectedPattern)
    {
        _expectedPattern = expectedPattern;
    }

    void
    setExpectedCount(const int count)
    {
 ...
 private:
    ...
    std::vector<Sequence*>&
    collectSequences(std::vector<Sequence*>& vec)
    {
        return vec;
    }
    ...
    static void
    markAsVerified(std::vector<Invocation*>& matchedInvocations)
    {
    ...
    bool
    atLeastLimitNotReached(int actualCount)
    {
        return actualCount < -_expectedCount;
    }

    bool
    exactLimitNotMatched(int actualCount)
    {
        return actualCount != _expectedCount;
    }

    void
    handleExactVerificationEvent(
        VerificationEventHandler& verificationErrorHandler,
        std::vector<Invocation*> actualSequence,
        int count)
    {
        SequenceVerificationEvent evt(
            VerificationType::Exact,
            _expectedPattern,
            actualSequence,
            _expectedCount,
            count);
    ...
    void
    handleAtLeastVerificationEvent(
        VerificationEventHandler& verificationErrorHandler,
        std::vector<Invocation*> actualSequence,
        int count)
    {
        SequenceVerificationEvent evt(
            VerificationType::AtLeast,
            _expectedPattern,
            actualSequence,
            -_expectedCount,
            count);
...
class ThrowFalseEventHandler : public VerificationEventHandler
{
    ...
    void
    handle(const SequenceVerificationEvent&) override
    {
        throw false;
    }

    void
    handle(const NoMoreInvocationsVerificationEvent&) override
    {
        throw false;
    }
};
...
class SequenceVerificationProgress
{
    ...
    virtual void
    verifyInvocations(const int times)
    {
...
class UsingProgress
{
    ...
    void
    collectSequences(std::vector<fakeit::Sequence*>&)
    {
    }
    ...
    void
    collectSequences(
        std::vector<fakeit::Sequence*>& vec,
 ...
 public:
    ...
    template<typename... list>
    SequenceVerificationProgress
    Verify(const fakeit::Sequence& sequence, const list&... tail)
    {
...
class VerifyFunctor
{
 ...
 public:
    ...
    template<typename... list>
    SequenceVerificationProgress
    operator()(const Sequence& sequence, const list&... tail)
    {
        std::vector<Sequence*> allSequences{
...
class VerifyNoOtherInvocationsVerificationProgress
{
    ...
    struct VerifyNoOtherInvocationsExpectation
    {
     ...
     private:
        ...
        VerifyNoOtherInvocationsExpectation(
            const VerifyNoOtherInvocationsExpectation& other)
            = default;
        ...
        VerifyExpectation(VerificationEventHandler& verificationErrorHandler)
        {
            ...
            std::unordered_set<Invocation*> actualInvocations;
            InvocationUtils::collectActualInvocations(
                actualInvocations, _mocks);
            ...
            if (nonVerifiedInvocations.size() > 0)
            {
                ...
                InvocationUtils::sortByInvocationOrder(
                    actualInvocations, sortedActualInvocations);
...
class SpyFunctor
{
 private:
    template<
        ...
        = 0>
    void
    spy(const SpyingContext<R, arglist...>& root, int)
    {
    ...
    template<typename R, typename... arglist>
    void
    spy(const SpyingContext<R, arglist...>&, long)
    {
        static_assert(
...
class SpyWithoutVerifyFunctor
{
 private:
    template<typename R, typename... arglist>
    void
    spy(const SpyingContext<R, arglist...>& root)
    {
        SpyingContext<R, arglist...>& rootWithoutConst
            = const_cast<SpyingContext<R, arglist...>&>(root);
        auto methodFromOriginalVT
